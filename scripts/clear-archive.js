...
dmz.ui.mainWindow.addMenu(self, "&File", "Clear Cache", function () {
   ...
   dmz.ui.messageBox.create(
      ...
      , text: "Are you sure you wish to clear your local MINDMAP data cache?"
      , informativeText: "This will immediately exit MINDMAP. Data will be re-downloaded upon launching the game."
